...
var qabot = require("meta4qa"), cli = qabot.cli, Runtime = qabot.Runtime, files = qabot.helpers.files, vars = qabot.helpers.vars, assert = qabot.assert, _ = qabot._;
